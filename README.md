...
- ✅ **آلبوم واقعی تلگرام** برای carouselهای عکس/ویدیو (حداکثر ۱۰ رسانه در هر آلبوم طبق محدودیت تلگرام)
- ✅ **کپشن expandable blockquote** مطابق فرمت رسمی تلگرام؛ کپشن‌های بلند به‌صورت فایل UTF-8 ضمیمه می‌شوند
- ✅ **آمار تازه** در زمان polling و بلافاصله پیش از ارسال: followers، following، posts، likes، comments و views در صورت ارائه توسط Instagram
...
### رفتار آلبوم و کپشن تلگرام

- carouselهای ۲ تا ۱۰ رسانه‌ای با یک فراخوانی گروهی MTProto ارسال می‌شوند.
- carouselهای بزرگ‌تر از ۱۰ رسانه به چند آلبوم معتبر تقسیم می‌شوند و آلبوم‌های بعدی در پاسخ به اولین پیام قرار می‌گیرند.
- فقط اولین رسانه‌ی آلبوم کپشن دارد تا پیام‌ها تکراری نشوند.
- متن کپشن داخل `<blockquote expandable>` قرار می‌گیرد.
- اگر متن قالب‌بندی‌شده از محدودیت ۱۰۲۴ کاراکتری کپشن رسانه عبور کند، نسخه‌ی کامل و بدون تغییر کپشن اصلی در فایل `.txt` و به‌صورت reply ارسال می‌شود.
- شمارنده‌های پروفایل و پست از API اینستاگرام تازه‌سازی می‌شوند. مقدار views فقط زمانی نمایش داده می‌شود که Instagram آن را در پاسخ API ارائه کند.
